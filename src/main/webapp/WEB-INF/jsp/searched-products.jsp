...
<div class="page-wrapper">
  ...
  <main class="main">
    <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
      <div class="container">
        <h1 class="page-title">${productName}<span>Shop</span></h1>
      </div><!-- End .container -->
    </div><!-- End .page-header -->
    ...
    <div class="page-content">
      <div class="container">
        <c:if test="${empty allProducts}">
          <h1 class="error-title text-center ">There is no products</h1><!-- End .error-title -->
        </c:if>
        <c:if test="${!empty allProducts}">
          <div class="products">
            <div class="row" id="productsDiv">
              <%@ include file="components/searched-products-component.jsp" %>
