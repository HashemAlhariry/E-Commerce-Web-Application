                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="${singleProduct.mainImage}" data-zoom-image="${singleProduct.mainImage}" alt="product image">
                            ...
                            <c:forEach items="${relatedProducts}" var="product">
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="amazonya/single-product-page?productId=${product.id}">
